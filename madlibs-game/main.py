...
root.title('The Amalie Mad Libs Generator')
Label(root, text= 'Mad Libs Generator \n Lets go!' , font = 'arial 20 bold').pack()
...
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'teal').place(x=70, y=180)
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'purple').place(x=80, y=240)
